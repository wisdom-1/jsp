...
<p>
	...
	이러한 특성을 상태가 유지되지 않는다해서 stateless라고 부른다. <br>
	요청은 계속해서 유지되지 않기 때문에 유지되어야 하는 정보를 저장하기에는 부족하다. <br> 
</p>

<p>
	쿠키는 유지되어야 하는 정보를 Key=Value형태로 클라이언트의 웹 브라우저에 저장한다. <br>
	서버에서 쿠키를 생성하여 클라이언트에게 보낼 응답에 실어서 보내면, <br> 
	브라우저가 그것 응답을 해석하여 브라우저에 쿠키를 등록한다. <br> 
</p>
